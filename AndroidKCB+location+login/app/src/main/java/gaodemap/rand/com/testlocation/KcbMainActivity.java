...
public class KcbMainActivity extends AppCompatActivity {

    //星期几
    private RelativeLayout day;

    //SQLite Helper类
    private KcbDatabaseHelper kcbDatabaseHelper = new KcbDatabaseHelper
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kcb_activity_main);
    ...
    private void loadData() {
        ...
        SQLiteDatabase sqLiteDatabase =  kcbDatabaseHelper.getWritableDatabase();
    ...
    private void createLeftView(Course course) {
        ...
        if (len > maxCoursesNumber) {
            for (int i = 0; i < len-maxCoursesNumber; i++) {
                View view = LayoutInflater.from(this).inflate(R.layout.kcb_left_view, null);
    ...
    private void createCourseView(final Course course) {
        ...
        if ((getDay < 1 || getDay > 7) || course.getStart() > course.getEnd())
            ...
            final View v = LayoutInflater.from(this).inflate(R.layout.kcb_course_card, null); //加载单个课程布局
            ...
            final TextView text = v.findViewById(R.id.text_view);
            ...
            text.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (course.getCourseName().equals("zz")){
                        Intent intent = new Intent(KcbMainActivity.this, MapActivity.class);
                        intent.putExtra("class", course.getClassRoom().toString());
                        //intent.putExtra("location", course.getClassRoom());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.kcb_toolbar, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add_courses:
                Intent intent = new Intent(KcbMainActivity.this, KcbAddCourseActivity.class);
                startActivityForResult(intent, 0);
                break;
            case R.id.menu_about:
                Intent intent1 = new Intent(this, KcbAboutActivity.class);
